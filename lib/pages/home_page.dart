...
import 'package:gameshowcase/widgets/scrollable_games_widget.dart';
import '../data.dart';
...
class _HomePageState extends State<HomePage> {
              ...
              child: Column(
                children: <Widget>[
                  Padding(
                    ...
                    child: ScrollableGamesWidget(_deviceWidth,_deviceHeight * 0.24, true, games),
                  ),
                  _featureGamesBannerWidget(),
                  Padding(
                    padding: EdgeInsets.symmetric(vertical: _deviceHeight * 0.01),
                    child: ScrollableGamesWidget(_deviceWidth,_deviceHeight * 0.24, false, games2),
                  ),
                ],
              ),
            ),
 ...
 Widget _featuredGamesInfoWidget() {
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Row(
            ...
            crossAxisAlignment: CrossAxisAlignment.center,
            children: featuredGames.map((_games){
              bool isActive = _games.title == featuredGames[_selectedGame].title;
              double circleRadius = _deviceHeight * 0.004;
              return Container(
                margin: EdgeInsets.only(right: _deviceWidth * 0.03),
  ...
  Widget _featureGamesBannerWidget() {
    return Container(
      width: _deviceWidth,
      height: _deviceHeight * 0.15,
      child: Container(
